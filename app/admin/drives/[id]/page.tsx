  ...
  return (
    <div>
      ...
      <div className="flex flex-wrap gap-2 mb-6">
        <LinkButton href={`/admin/candidates?driveId=${drive.id}`} className="btn-primary">View candidates →</LinkButton>
      ...
      <Card className="text-sm text-slate-600">{drive._count.applications} applications. Use the candidate search to filter by stage, score, university and more.</Card>
    </div>
  );
}
