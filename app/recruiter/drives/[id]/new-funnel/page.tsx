...
export default async function NewFunnelPage({ params: paramsPromise }: { params: Promise<{ id: string }> }) {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <FunnelBuilder driveId={drive.id} />
      <div className="mt-4">
        <LinkButton href={`/recruiter/drives/${drive.id}`} className="btn-ghost">← Cancel</LinkButton>
      </div>
    </div>
  );
}
